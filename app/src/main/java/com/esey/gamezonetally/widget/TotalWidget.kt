...
class TotalWidget(private val group: Group) : GlanceAppWidget() {
...
class Ps5TotalWidgetReceiver : GlanceAppWidgetReceiver() {
    override val glanceAppWidget: GlanceAppWidget = TotalWidget(Groups.PS5)
}

class XboxTotalWidgetReceiver : GlanceAppWidgetReceiver() {
    override val glanceAppWidget: GlanceAppWidget = TotalWidget(Groups.XBOX)
}
